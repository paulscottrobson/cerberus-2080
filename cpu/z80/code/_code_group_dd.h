...
case 0x2c: /**** $2c:inc $il ****/
	temp8 = IZ(); ZINC8(temp8); IZ() = (IZ() & 0xFF00) | temp8;;
	CYCLES(8);break;

case 0x2d: /**** $2d:dec $il ****/
	temp8 = IZ(); ZDEC8(temp8); IZ() = (IZ() & 0xFF00) | temp8;;
	CYCLES(8);break;

case 0x34: /**** $34:inc ($i$o) ****/
	temp16 = IZDISP8(); temp8 = READ8(temp16); ZINC8(temp8); WRITE8(temp16,temp8);;
	CYCLES(23);break;

case 0x35: /**** $35:dec ($i$o) ****/
	temp16 = IZDISP8(); temp8 = READ8(temp16); ZDEC8(temp8); WRITE8(temp16,temp8);;
	CYCLES(23);break;
...
case 0x86: /**** $86:add ($i$o) ****/
	ZALUADD(READ8(IZDISP8()));
	CYCLES(19);break;

case 0x8e: /**** $8e:adc ($i$o) ****/
	ZALUADC(READ8(IZDISP8()));
	CYCLES(19);break;

case 0x96: /**** $96:sub ($i$o) ****/
	ZALUSUB(READ8(IZDISP8()));
	CYCLES(19);break;

case 0x9e: /**** $9e:sbc ($i$o) ****/
	ZALUSBC(READ8(IZDISP8()));
	CYCLES(19);break;

case 0xa6: /**** $a6:and ($i$o) ****/
	ZALUAND(READ8(IZDISP8()));
	CYCLES(19);break;

case 0xae: /**** $ae:xor ($i$o) ****/
	ZALUXOR(READ8(IZDISP8()));
	CYCLES(19);break;

case 0xb6: /**** $b6:or ($i$o) ****/
	ZALUOR(READ8(IZDISP8()));
	CYCLES(19);break;

case 0xbe: /**** $be:cp ($i$o) ****/
	ZALUCP(READ8(IZDISP8()));
	CYCLES(19);break;
